...
//feature detect for ie8 and 9
var features = {
	hasXDomainRequest: 'XDomainRequest' in global,
	hasXMLHttpRequest : hasXMLHttpRequest,
	hasLevel2: hasXMLHttpRequest && "withCredentials" in new XMLHttpRequest
}

// beware of the limitation of xdr http://blogs.msdn.com/b/ieinternals/archive/2010/05/13/xdomainrequest-restrictions-limitations-and-workarounds.aspx, http://blogs.msdn.com/b/ie/archive/2012/02/09/cors-for-xhr-in-ie10.aspx 
agent.cors = function(method, url, data, callback){
	
	var request = new agent(method, url, data)
	if(features.hasXDomainRequest && !features.hasLevel2) {
		var xhr = request._xhr = new XDomainRequest()
        xhr.setRequestHeader = void 0
        request.send = function(send){return function(callback){
            xhr.onload = function(){
                callback(new Response(xhr.responseText, 100, ''))
                xhr.onload = void 0
            }
            send.call(request, void 0)
        }}(request.send)
    }
